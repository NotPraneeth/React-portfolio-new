      ...
      <Link to='/' className='navbar-logo'> PRANEETH</Link>
        ...
        <div className='socials-nav'>
               <ul className='list-nav'>
                  ...
                  <motion.div initial={{width:"0%" }} whileInView={{width:"100%"}} transition={{duration:1.25,ease:"easeOut"}} className= 'button-container'>
                  <motion.button initial={{y:"-100%" }} whileInView={{y:0}} transition={{duration:1.5,ease:"easeOut"}} className='download-btn'><Link to='/files/resume.pdf' className='btn-link' target='_blank' download>DONWLOAD RESUME</Link></motion.button>
                  </motion.div>
