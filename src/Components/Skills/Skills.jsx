  ...
  return (
    <motion.div initial={{opacity:0 }} animate={{opacity:1}} transition={{duration:0.75,ease:"easeOut"}} className='Skills-container'>
        ...
        <div className='skills-content'>
          <motion.div transition={{duration:0.5,ease:[0.6,0.1,-0.05,0.9]}} initial={{opacity:0}} whileInView={{opacity:1}}  className='skills1'>WHAT I AM GOOD AT</motion.div>
          ...
          <motion.div transition={{duration:0.5,ease:[0.6,0.1,-0.05,0.9]}} initial={{opacity:0}} whileInView={{opacity:1}} className='skills2'>LET'S TALK WORK</motion.div>
        </div>
