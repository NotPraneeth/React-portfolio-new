        ...
        <motion.div className='Landing-hero-content'>
          <span className='landing-text'>
            <div className='hello-container'>
              <motion.span initial={{y:"100%"}} whileInView={{y:"0"}} transition={{duration:1,ease:'easeOut'}} className='hello-landing'>hello</motion.span>
              <div className='hello-text-container'>
              <motion.div initial={{y:"300%"}} whileInView={{y:"100%"}} transition={{duration:1,ease:'easeOut',delay:0.2}} className='hello-text'> your project is cool 😎 <br></br> but let's make it cooler🎉</motion.div>
              </div>
            </div>
